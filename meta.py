...
This experiment was created using PsychoPy3 Experiment Builder (v3.2.3),
    on qui 24 out 2019 18:04:12 -03
...
for thisComponent in inter_timeComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('text_it.started', text_it.tStartRefresh)
thisExp.addData('text_it.stopped', text_it.tStopRefresh)
...
for thisComponent in respostaComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('text_resposta.started', text_resposta.tStartRefresh)
thisExp.addData('text_resposta.stopped', text_resposta.tStopRefresh)
# check responses
